                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List of Staff Details</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="box">
                                    <table  class="table table-bordered" id= "dataTable" width="100%" cellspacing="0">
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                            <td><?php if (isset($staffdetail->email)) echo htmlspecialchars($staffdetail->email, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php if (isset($staffdetail->phoneno)) echo htmlspecialchars($staffdetail->phoneno, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php if (isset($staffdetail->firstname)) echo htmlspecialchars($staffdetail->firstname, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php if (isset($staffdetail->lastname)) echo htmlspecialchars($staffdetail->lastname, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php if (isset($staffdetail->title)) echo htmlspecialchars($staffdetail->title, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php if (isset($staffdetail->dept)) echo htmlspecialchars($staffdetail->dept, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php if (isset($staffdetail->station)) echo htmlspecialchars($staffdetail->station, ENT_QUOTES, 'UTF-8'); ?></td>
